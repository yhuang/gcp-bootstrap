locals {
  tfc_project_id = data.tfe_project.main.id

  tfc_workspace_id = {
    "host-vpc-project" = tfe_workspace.host_vpc_project.id
    "service-project"  = tfe_workspace.service_project.id
  }
  ...
  tfc_gcp_workspace_subject_value = ""
